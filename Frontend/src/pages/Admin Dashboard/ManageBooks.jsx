  ...
  return (
    <>
      <style>{`
            ...
            .mb-row { transition: background 150ms ease; }
            .mb-row:hover { background: #fefce8; }
            .mb-row:hover .mb-cover { transform: scale(1.04); }
            .mb-cover { transition: transform 200ms ease; }
          `}</style>

      <div className="mb-root min-h-screen bg-stone-50 px-6 py-10 md:px-12">
        {/* Page Header */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <h1 className="mb-serif text-3xl text-stone-900 leading-tight">
              Book Catalogue
            </h1>
          </div>
          <Link
